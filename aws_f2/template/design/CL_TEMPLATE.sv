...
`ifdef DNHACKS_FIXED
  localparam bit EFFECTIVE_FIXED_WEIGHTS = 1'b1;
`else
  localparam bit EFFECTIVE_FIXED_WEIGHTS = FIXED_WEIGHTS;
`endif
...
//=============================================================================
  ...
  dnhacks_matvec_axi #(.FIXED_WEIGHTS(EFFECTIVE_FIXED_WEIGHTS)) MATVEC_AXI (
    .clk          (clk_main_a0),
    .rst_n        (rst_main_n),
