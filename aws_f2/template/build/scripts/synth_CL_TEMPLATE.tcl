...
set dnhacks_verilog_defines [list XSDB_SLV_DIS]
if {[info exists ::env(DNHACKS_FIXED)] && $::env(DNHACKS_FIXED) == "1"} {
  lappend dnhacks_verilog_defines DNHACKS_FIXED
}

synth_design -mode out_of_context \
             -top ${CL} \
             -verilog_define $dnhacks_verilog_defines \
             -part ${DEVICE_TYPE} \
