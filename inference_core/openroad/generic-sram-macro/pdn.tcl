# SKY130HD default PDN plus the lowercase OpenRAM macro supply pins.
# The standard-cell platform uses VDD/VSS; the supplied OpenRAM views name
# their supplies vdd/gnd.  Global connections bind those physical macro pins
# to the same core voltage domain before macro-grid generation.
